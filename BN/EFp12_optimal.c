#include "BN12_header.h"

unsigned long int num,mpz_mpz_mul,mpz_ui_mul,Fp_sqr,mpz_mpz_add,mpz_ui_add,basis_mul_num,Fp_inv_num;
/*============================================================================*/
/* main                                                                       */
/*============================================================================*/
int main(){
...
///< 2> 8-sparse:1+(α+1)^-1*a'[βγ]+(α+1)^-1*b'[β^2γ]
